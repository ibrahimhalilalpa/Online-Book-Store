...
//check if book name is logged in
...
//If all input field are filled
  ...
  isset($_POST['book_language']) &&
    ...
    $language    = $_POST['book_language'];
        ...
        //Get current cover and file from POST request and store them in var.
		...
		$current_file     = $_POST['current_file'];
            ...
            $location = "../edit-book.php";
            $ms = "id=$id&error";
            is_empty($language, $text, $location, $ms, "");
            ...
            if ($book_cover['status'] == "error" || 
              ...
              **/
               ...
               $book_cover_URL = $book_cover['data'];
                ...
                $res  = $stmt->execute([$title, $author, $description, $language, $category,$book_cover_URL, $file_URL, $id]);
               ...
               $book_cover_URL = $book_cover['data'];
                ...
                # update just the data
                  $sql = "UPDATE books
                          ...
                          WHERE id=?";
                  $stmt = $conn->prepare($sql);
                $res  = $stmt->execute([$title, $author, $description, $language, $category,$book_cover_URL, $id]);
        ...
        if ($file['status'] == "error") {
          ...
          **/
           $file_URL = $file['data'];
            ...
            # update just the data
              $sql = "UPDATE books
                      ...
                      WHERE id=?";
              $stmt = $conn->prepare($sql);
            $res  = $stmt->execute([$title, $author, $description, $language, $category, $file_URL, $id]);
          ...
          $sql = "UPDATE books
                  ...
                  WHERE id=?";
          $stmt = $conn->prepare($sql);
        $res  = $stmt->execute([$title, $author, $description, $language, $category, $id]);
